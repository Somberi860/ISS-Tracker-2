...
export default class MeteorScreen extends Component {
    ...
    renderItem =({item}) => {
        ...
        return(
            ...
            <Text style = {[styles.cardTitle,{marginTop:400, marginLeft:50}]}>closest to earth-{item.close_approach_data[0].close_approach_date_full}</Text>
            <Text style = {[styles.cardTitle,{marginTop:400, marginLeft:50}]}>Minimum Diameter(KM)-{item.estimated_diameter.kilometers.estimated_diameter_min}</Text>
            <Text style = {[styles.cardTitle,{marginTop:400, marginLeft:50}]}>Maximum Diameter(KM)-{item.estimated_diameter.kilometers.estimated_diameter_max}</Text>
            <Text style = {[styles.cardTitle,{marginTop:400, marginLeft:50}]}>Velocity(KM/H)-{item.close_approach_data[0].relative_velocity.kilometers_per_hour}</Text>
            <Text style = {[styles.cardTitle,{marginTop:400, marginLeft:50}]}>Missing Earth By(KM)-{item.close_approach_data[0].miss_distance.kilometers}</Text>
            </View>
            </View>
            </ImageBackground>
            </View>
